...
public class SMTPTemplate extends Authenticator {

	public PasswordAuthentication getPasswordAuthentication() {
		Properties prop = new Properties();
		PasswordAuthentication pa = null;
		String path = SMTPTemplate.class.getResource("/common/template/smtp.properties").getPath();
		try {
	...
	public static boolean sendmail(String content, String to, String subject) {
		boolean isSend = true;
		String user = "11agumon@gmail.com"; // 네이버일 경우 네이버 계정, gmail경우 gmail 계정
		String password = "gustlrl.41";
		// SMTP 서버 정보를 설정한다.
		Properties prop = new Properties();
