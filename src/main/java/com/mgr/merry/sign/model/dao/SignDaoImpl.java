...
//	}
	...
	@Override
	public List<SupLvUploadImg> insertsuplvimg(SqlSessionTemplate session, int supNo) {
		return session.selectList("sign.insertsuplvimg", supNo);
	}

	@Override
	public SupLvUpload selectSlut(SqlSessionTemplate session, int supNum) {
		return session.selectOne("sign.selectSlut", supNum);
	}
